...
public class FieldValidationError {
    ...
    @Schema(description = "Description of the error that occurred", example = "must have at least 3 characters")
    private String message;
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @Schema(description = "The value that was passed to this field", example = "dé")
